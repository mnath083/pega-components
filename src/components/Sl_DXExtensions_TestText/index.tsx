...
import StyledSlDxExtensionsTestTextWrapper from './styles';
...
function SlDxExtensionsTestText(props: SlDxExtensionsTestTextProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledSlDxExtensionsTestTextWrapper> {displayComp} </StyledSlDxExtensionsTestTextWrapper>
    ) : (
      <StyledSlDxExtensionsTestTextWrapper>
        <FieldValueList
...
export default withConfiguration(SlDxExtensionsTestText);
