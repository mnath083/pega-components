...
const { BaseSlDxExtensionsNavigateWrapper } = composeStories(DemoStories);

test('renders SlDxExtensionsNavigateWrapper', async () => {
  render(<BaseSlDxExtensionsNavigateWrapper />);
