...
import StyledSlDxExtensionsNavigateWrapperWrapper, { StyledDetailsGridContainer, StyledHighlightedFieldsHrLine } from './styles';
...
function SlDxExtensionsNavigateWrapper(props: SlDxExtensionsNavigateWrapperProps) {
  ...
  return (
    <StyledSlDxExtensionsNavigateWrapperWrapper>
